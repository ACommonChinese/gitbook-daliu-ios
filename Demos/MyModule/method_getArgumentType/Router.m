...
- (Invocation *)invocationForUrl:(NSString *)url {
    ...
    if (!invocation) {
        [self addInvocationForUrl:url type:ZZModuleRouterInvocationTypeClass];
        [self addInvocationForUrl:url type:ZZModuleRouterInvocationTypeInstance];
    }
    return [self.routers objectForKey:url];
}

- (void)addInvocationForUrl:(NSString *)url type:(ZZModuleRouterInvocationType)invocationType {
    ...
    if (invocationType == ZZModuleRouterInvocationTypeClass) {
